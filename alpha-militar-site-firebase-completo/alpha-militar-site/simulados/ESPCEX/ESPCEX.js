...
/* SIMULADOS ESPCEX COMPLETOS - Alpha Militar
...
const simulados = {
  "Simulado Diagnóstico": {
    ...
    descricao: "50 questões para medir sua base no padrão ESPCEX. Mistura Matemática, Português, História, Geografia, Inglês e Redação.",
    tempoMinutos: 150,
    questoes: [
      ...
      {materia:"Matemática", dificuldade:"Médio", pergunta:"Uma caixa d’água cilíndrica tem altura 15 m e diâmetro 5 m. Usando π = 3,14, qual é a área total?", opcoes:["152,5 m²","196,25 m²","235,25 m²","274,75 m²","360 m²"], correta:"274,75 m²", explicacao:"A área total é 2πr² + 2πrh = 2·3,14·2,5² + 2·3,14·2,5·15 = 274,75 m²."},
      ...
      {materia:"Português", dificuldade:"Médio", pergunta:"Na frase 'Os alunos da ESPCEX chegaram cedo', o núcleo do sujeito é:", opcoes:["ESA","cedo","alunos","chegaram","da ESPCEX"], correta:"alunos", explicacao:"O núcleo do sujeito é o substantivo principal 'alunos'."},
  ...
  "Simulado ESPCEX 01": {
    titulo: "Simulado ESPCEX 01 · Padrão Prova Completa",
    descricao: "Simulado completo com 50 questões em nível ESA, maior cobrança de matemática e interpretação.",
    tempoMinutos: 150,
    questoes: []
  },
  "Simulado ESPCEX 02": {
    titulo: "Simulado ESPCEX 02 · Nível Intermediário/Avançado",
...
const bancoESA02 = [
  ...
  {materia:"Matemática", dificuldade:"Difícil", figura:"venn3", pergunta:"Em uma pesquisa com 60 alunos: B=27, F=20, V=25, B∩F=5, B∩V=8, F∩V=7 e B∩F∩V=2. Quantos preferem pelo menos uma modalidade?", opcoes:["40","48","50","52","54"], correta:"54", explicacao:"Pela inclusão-exclusão: 27+20+25−5−8−7+2 = 54."},
...
simulados["Simulado ESPCEX 01"].questoes = bancoESA01.slice(0, 50);
simulados["Simulado ESPCEX 02"].questoes = bancoESA02.slice(0, 50);
...
function abrirSimulado(nome){
  ...
  box.innerHTML = `
    <div class="simulado-info-box">
      ...
      <span>${simuladoAtual.questoes.length} questões · nível ESPCEX · correção automática</span><br>
...
function corrigirSimulado(tempoEsgotado = false){
  ...
  const desempenho = nota >= 80 ? 'Excelente. Você já está competitivo no padrão ESPCEX.' : nota >= 65 ? 'Bom. Falta lapidar os erros e ganhar velocidade.' : nota >= 50 ? 'Regular. Reforce teoria e refaça as questões erradas.' : 'Atenção. Volte às bases e faça revisão por matéria.';
